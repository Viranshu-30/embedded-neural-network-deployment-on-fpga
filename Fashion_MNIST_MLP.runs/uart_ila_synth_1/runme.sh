...
HD_PWD='D:/Vivado/Fashion_MNIST_MLP/Fashion_MNIST_MLP.runs/uart_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_ila.tcl
