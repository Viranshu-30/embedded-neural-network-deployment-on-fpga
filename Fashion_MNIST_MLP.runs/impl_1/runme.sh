...
HD_PWD='D:/Vivado/Fashion_MNIST_MLP/Fashion_MNIST_MLP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fashion_mnist_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fashion_mnist_top.tcl -notrace
