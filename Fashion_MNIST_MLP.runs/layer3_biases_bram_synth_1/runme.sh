...
HD_PWD='D:/Vivado/Fashion_MNIST_MLP/Fashion_MNIST_MLP.runs/layer3_biases_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer3_biases_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer3_biases_bram.tcl
