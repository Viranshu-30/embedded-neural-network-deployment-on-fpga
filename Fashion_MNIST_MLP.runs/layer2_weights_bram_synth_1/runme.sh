...
HD_PWD='D:/Vivado/Fashion_MNIST_MLP/Fashion_MNIST_MLP.runs/layer2_weights_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer2_weights_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer2_weights_bram.tcl
