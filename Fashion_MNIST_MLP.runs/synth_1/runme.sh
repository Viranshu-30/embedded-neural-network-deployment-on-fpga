...
HD_PWD='D:/Vivado/Fashion_MNIST_MLP/Fashion_MNIST_MLP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fashion_mnist_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fashion_mnist_top.tcl
