...
HD_PWD='D:/Vivado/Fashion_MNIST_MLP/Fashion_MNIST_MLP.runs/image_bram_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_bram_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_bram_ip.tcl
