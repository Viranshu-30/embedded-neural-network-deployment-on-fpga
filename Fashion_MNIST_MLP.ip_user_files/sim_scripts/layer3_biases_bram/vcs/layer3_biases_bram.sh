...
#
# Script generated by Vivado on Mon Jul 14 16:11:45 -0700 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : layer3_biases_bram.sh
...
#
# Usage        : layer3_biases_bram.sh
#                layer3_biases_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                layer3_biases_bram.sh [-reset_run]
#                layer3_biases_bram.sh [-reset_log]
#                layer3_biases_bram.sh [-help]
#
...
#                script (type 'layer3_biases_bram.sh -help' for more information).
#
...
# script info
echo -e "layer3_biases_bram.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./layer3_biases_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.layer3_biases_bram xil_defaultlib.glbl -o layer3_biases_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./layer3_biases_bram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key layer3_biases_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc layer3_biases_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./layer3_biases_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: layer3_biases_bram.sh [-help]\n\
Usage: layer3_biases_bram.sh [-step]\n\
Usage: layer3_biases_bram.sh [-lib_map_path]\n\
Usage: layer3_biases_bram.sh [-reset_run]\n\
Usage: layer3_biases_bram.sh [-reset_log]\n\
Usage: layer3_biases_bram.sh [-keep_index]\n\
Usage: layer3_biases_bram.sh [-noclean_files]\n\n\
